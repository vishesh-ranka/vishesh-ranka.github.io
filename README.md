# vishesh-ranka.github.io

Source for my personal site: **https://vishesh-ranka.github.io**

I'm a supply chain and operations analyst in Los Angeles, currently doing an M.S. in
Engineering Management at USC along with a Graduate Certificate in Optimization and
Supply Chain Management at USC Marshall. The site covers my internship experience, two
analytics projects, and how to reach me.
...
| File | What it is |
| --- | --- |
| `index.html` | The whole site. One self-contained file: HTML, CSS, and JavaScript together, no build step and no dependencies beyond Google Fonts. |
| `resume.pdf` | My resume, served by the download buttons on the page. |

To work on it, open `index.html` in a browser. There is nothing to install and nothing to
compile. Pushing to `main` deploys to GitHub Pages within about a minute.
